...
export default function Home() {
  ...
  const statistics = [
    {
      img: '/project_stat.svg',
      number: '25+',
      title: 'Projects Completed'
    },
    {
      img: '/clients_stat.svg',
      number: '15+',
      title: 'Happy Clients'
    },
    {
      img: '/creators_stat.svg',
      number: '5+',
      title: 'Digital Creators'
    },
    {
      img: '/innovation_stat.svg',
      number: '100%',
  ...
  return (
    <main className="relative">
      ...
      <section className="about_us mt-30 pb-20 relative min-[992px]:px-15 px-10 max-[576px]:px-6">
